...
class App(CTk):
    ...
    def change_train_label(self):
        self.train_label.configure(text="Model is trained!")
    ...
    def forecast(self):
        ...
        self.canvas = FigureCanvasTkAgg(fig, master=self.tab3)
    ...
    def save_forecast(self):
        ...
        self.predictions.to_csv(f"{dirname}/forecast.csv")
    ...
    def widgets(self):
        ...
        self.data_label = ct.CTkLabel(self.tab3,
                                       text="Electric Vehicles Sales")
        self.data_label.pack()
        self.canvas = FigureCanvasTkAgg(self.fig1, master=self.tab3)
        self.canvas.get_tk_widget().pack(expand=True, fill='both')
        self.clear_data()
